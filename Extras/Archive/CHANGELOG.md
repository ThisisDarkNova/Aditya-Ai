...
### Added
- Initial release of VESPERA OS (sentient cognitive operating system).
- Jarvis-level AI persona directives (Strategist, Coach, Operator, Analyst, Chief of Staff).
- Deep integration for gaming monitors tracking Minecraft, Fortnite, and OBS.
- Dynamic workspace switching logic with responsive thought loops.
- Standalone compiled Python backend executable (`VesperaCore.exe`).
