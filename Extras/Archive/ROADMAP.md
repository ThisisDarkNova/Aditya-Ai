...
- [ ] Add voice pitch/personality selection.
- [ ] Integrate local database indexing for instant local code/file lookups.

## 🎮 Q4 2026: Gaming & Study Integrations
- [ ] Support custom game performance profiles (optimized CPU prioritization).
- [ ] Add automatic study-mode summaries (extracting highlights from documents/PDFs opened during session).
