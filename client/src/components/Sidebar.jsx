...
import { Home, User, Settings, Mic, Wifi, Shield, MessageCircle, ChevronRight, ChevronLeft } from 'lucide-react';
  ...
  return (
    ...
    >
      ...
      <div style={{ padding: '20px 0 16px', display: 'flex', flexDirection: 'column', alignItems: 'center', gap: 8 }}>
        ...
        >
          <span style={{ color: '#fff', fontSize: 16, fontWeight: 700 }}>Æ</span>
        </div>
