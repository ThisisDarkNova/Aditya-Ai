...
"""
PC Optimizer & Diagnostics system tool for Vespera.
...
logger = logging.getLogger("vespera-pc-optimizer")
...
def optimize_gaming_mode() -> str:
    """
    Boosts Vespera's process priority and schedules background indexers to release resources.
    """
    try:
