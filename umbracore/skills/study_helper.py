...
"""
Notes & Quiz creator system tool for Vespera.
...
logger = logging.getLogger("vespera-study-helper")
...
def generate_notes_file(subject: str, topic: str, content: str) -> str:
    ...
    """
    try:
        workspace_dir = Path("c:/Users/waste/Downloads/Vespera-Ai/Vespera/workspace")
