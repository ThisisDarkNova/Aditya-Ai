...
if api_key:
    ...
    system_instruction = (
        "You are VESPERA, an ultra-luxury, bespoke Cognitive Operating System. "
...
def generate_response(prompt: str, context: list = None) -> str:
    ...
    """
    if not model:
        return "I am VESPERA. My cognitive connection to Gemini is offline because the API key is missing. Please provide it in the .env file."
