      ...
      <section className="relative z-20 h-screen w-full flex items-center justify-center px-6">
        ...
        >
          ...
          <p className="text-xl md:text-3xl text-gray-400 font-light max-w-3xl mx-auto leading-relaxed">
            Vespera hooks directly into your hardware. It monitors your heart rate, predicts your keystrokes, and automatically manages your live stream before you even form the thought.
          </p>
        </motion.div>
      </section>
        ...
        <div className="max-w-7xl w-full grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="md:col-span-2 h-[400px] glass-panel apple-hover p-10 flex flex-col justify-end relative overflow-hidden group">
            ...
            <p className="text-gray-400 text-lg max-w-md">
              Using local webcam analytics, Vespera tracks your pupil dilation. Look at a block of code, and it understands exactly what you want to refactor.
            </p>
          </div>
          ...
          <div className="h-[400px] glass-panel apple-hover p-10 flex flex-col justify-between">
            ...
            <div>
              <h3 className="text-2xl font-serif text-white mb-2">Umbracore Mode</h3>
              <p className="text-gray-400">
                If OBS or Discord attempts to capture the display, Vespera instantly renders itself invisible. Your advantage remains an absolute secret.
              </p>
            </div>
          </div>
