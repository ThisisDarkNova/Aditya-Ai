...
import AdityaMemoryEngineTab from './AdityaMemoryEngineTab';
...
export default function Settings({ settings, saveSettings, setActivePage, activePersona, onSelectPersona }) {
  ...
  const tabs = [
    ...
    { id: 'AdityaMemoryEngine', icon: Brain },
  ...
  const renderContent = () => {
    switch(activeTab) {
      ...
      case 'AdityaMemoryEngine':
        return <AdityaMemoryEngineTab />;

      case 'About':
        return (
          <motion.div variants={stagger} initial="hidden" animate="visible" className="flex flex-col gap-6">
            <h2 style={{ fontSize: 24, fontWeight: 600, marginBottom: 8 }}>About Aditya</h2>
            <div className="glass-panel" style={{ padding: 32, textAlign: 'center' }}>
              ...
              <h3 style={{ fontSize: 20, fontWeight: 600 }}>ADITYA OS</h3>
