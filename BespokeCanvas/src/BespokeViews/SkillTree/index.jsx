...
const initialNodes = [
  { id: '1', type: 'custom', position: { x: 400, y: 100 }, data: { label: 'Aditya Core', desc: 'Neural Kernel engine', icon: <BrainCircuit size={20} color="#fff" />, color1: '#10B981', color2: '#059669' } },
    ...
    >
      <div className="absolute top-8 left-8 z-20 pointer-events-none">
        ...
        <p className="text-sm text-white/50 mt-2 max-w-sm" style={{ fontFamily: 'Inter, sans-serif' }}>
          Drag, drop, and connect neural pathways to customize your ADITYA OS capabilities. Changes reflect in real-time.
        </p>
      </div>
