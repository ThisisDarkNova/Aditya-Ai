...
export default function Docs() {
  ...
  const sections = [
    { title: "Getting Started", icon: <Terminal className="w-5 h-5" />, desc: "Initialize the Umbracore Engine." },
    { title: "Architecture", icon: <Server className="w-5 h-5" />, desc: "Deep dive into the Symbiosis Engine." },
    { title: "VS Code Extension", icon: <Code2 className="w-5 h-5" />, desc: "The Marginalia configuration." },
  ];
      ...
      <section className="flex-1 max-w-4xl">
        <motion.div initial={{ opacity: 0, y: 15 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }}>
          ...
          <p className="text-slate-400 text-base md:text-lg leading-relaxed mb-8">
            Vespera is not a standard AI assistant. It is a Sentient OS woven directly into your hardware, 
              ...
              {activeTab === 'package' && (
                <div className="space-y-6">
                  ...
                  <div className="glass-panel p-6 rounded-2xl border border-white/5 bg-white/[0.01]">
                    ...
                    <p className="text-slate-400 text-sm mb-4">Install Vespera globally using the Windows package manager.</p>
                  ...
                  <div className="glass-panel p-6 rounded-2xl border border-white/5 bg-white/[0.01]">
                    ...
                    <pre className="bg-black/40 p-4 rounded-xl border border-white/10 text-blue-300 font-mono text-xs md:text-sm overflow-x-auto space-y-1.5 select-all">
                      ...
                      <div>scoop install extras/vespera</div>
                    </pre>
                  </div>
              ...
              {activeTab === 'manual' && (
                <div className="space-y-6">
                  ...
                  <div className="glass-panel p-6 rounded-2xl border border-white/5 bg-white/[0.01]">
                    ...
                    <pre className="bg-black/40 p-4 rounded-xl border border-white/10 text-blue-300 font-mono text-xs md:text-sm overflow-x-auto select-all">
                      git clone https://github.com/DarkNova/Vespera.git
                    </pre>
                  </div>
                  ...
                  <div className="glass-panel p-6 rounded-2xl border border-white/5 bg-white/[0.01]">
                    ...
                    <pre className="bg-black/40 p-4 rounded-xl border border-white/10 text-blue-300 font-mono text-xs md:text-sm overflow-x-auto select-all">
                      cd Vespera && .\install.ps1
                    </pre>
                  </div>

                  {/* step 3 */}
                  <div className="glass-panel p-6 rounded-2xl border border-white/5 bg-white/[0.01]">
                    <h3 className="text-slate-200 font-serif text-lg mb-2">3. Run Vespera Core</h3>
                ...
                <div className="space-y-6">
                  ...
                  <div className="glass-panel p-6 rounded-2xl border border-white/5 bg-white/[0.01]">
                    ...
                    <p className="text-slate-400 text-sm leading-relaxed">
                      ...
                      Configure port <code className="text-blue-300 font-mono">4455</code> to grant Vespera control over scenes.
                    </p>
                  </div>
                </div>
              )}
            ...
            <div className="glass-panel p-6 rounded-2xl border border-white/5 bg-white/[0.01] flex flex-col justify-between">
              <div>
                ...
                <ul className="text-slate-400 text-xs md:text-sm space-y-2 mt-4 list-disc list-inside">
                  <li>Python 3.11+ (For Umbracore Engine)</li>
            ...
            <div className="glass-panel p-6 rounded-2xl border-l-4 border-red-500/50 bg-white/[0.01] flex flex-col justify-between">
              <div>
                ...
                <p className="text-slate-400 text-xs md:text-sm leading-relaxed mt-4">
                  When Umbracore Mode is armed, Vespera will automatically detect Screen Recording software (e.g., Discord Screen Share) 
