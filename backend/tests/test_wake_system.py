...
from modules.settings_manager import SettingsManager, DEFAULT_SETTINGS, settings
from modules.startup_manager import get_startup_command
from core.aditya_runtime import AdityaRuntime
from modules.gaming_monitor import GamingMonitor
...
class TestSettingsManager(unittest.TestCase):
    ...
    def test_backup_and_recovery(self):
        manager = SettingsManager(path=self.settings_path, backup_path=self.backup_path)
        manager.set("wake_word", "Aditya Bot")
        ...
        self.assertEqual(recovery_manager.get("wake_word"), "Aditya Bot")
