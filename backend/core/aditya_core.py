...
def _process_single_command(command: str) -> str:
    ...
    # ── 6. MOUSE ─────────────────────────────────────────────────────────────
        ...
        from modules.app_opener import mouse_control
