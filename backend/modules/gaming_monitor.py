...
"""
Gaming Monitor for Aditya's DarkNova Mode.
...
logger = logging.getLogger("aditya-gaming")
...
class GamingMonitor:
    ...
    def _activate_gaming_mode(self) -> None:
        with self._lock:
            ...
            try:
                from ui_server import set_ui_control, set_status
    ...
    def _deactivate_gaming_mode(self) -> None:
        with self._lock:
            ...
            try:
                ...
                set_ui_control(message="Aditya Active")
            except Exception:
                pass
