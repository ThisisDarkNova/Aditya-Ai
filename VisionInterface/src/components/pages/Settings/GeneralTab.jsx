      ...
      <div className="glass-panel" style={{ padding: 24 }}>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 20 }}>
          <div>
            ...
            <p style={{ fontSize: 13, color: 'var(--color-text-secondary)' }}>Aditya's primary communication language.</p>
          </div>
        ...
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 20 }}>
          <div>
            ...
            <p style={{ fontSize: 13, color: 'var(--color-text-secondary)' }}>Launch Aditya automatically on boot.</p>
          </div>
          <div
