...
# CPU / RAM LIMITER: Set process priority to Below Normal so AI never lags the main system or exceeds ~60% CPU allocation natively
try:
...
from core.aditya_presence import ADITYA_PERSONA
...
from core.aditya_runtime import runtime
from core.model_config import get_fallback_chain
from core.aditya_voice import realtime, ResponseMode, NetworkMode
...
def _load_dotenv() -> None:
    """Load `.env` next to this script so GEMINI_API_KEY / GOOGLE_API_KEY work."""
...
def _build_config(resume_handle: Optional[str]) -> types.LiveConnectConfig:
    ...
    try:
        from core.system_monitor import sys_monitor
            ...
            for fc in msg.tool_call.function_calls:
                ...
                try:
                    if name == "process_command":
                        ...
                        from core.aditya_core import process_command
                        ...
                        from core.aditya_knowledge import learning_system
                        ...
                        try:
                            from core.aditya_society import autonomous_agent
                        ...
                        from modules.desktop_ops import list_windows
                        result = await asyncio.to_thread(list_windows)
                    elif name == "manage_windows":
                        from modules.desktop_ops import organize_windows
...
async def main() -> None:
    ...
    try:
        from core.aditya_society import AdityaSociety
...
if __name__ == "__main__":
    ...
    from modules.startup_manager import handle_delayed_startup, sync_startup_with_registry
    ...
    from core.aditya_kernel_supervisor import supervisor
    from core.aditya_guardian import resource_guard
    ...
    from modules.gaming_monitor import gaming_monitor
    ...
    # 1. Start the voice assistant in a background thread
    assistant_thread = threading.Thread(
        target=_run_async_main, name="assistant", daemon=True
    )
