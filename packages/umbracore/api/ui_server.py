...
from core.file_indexer import workspace_indexer
from core.research_worker import start_research, get_research_job, get_all_research_jobs
    ...
    def do_GET(self):
        ...
        try:
            ...
            if path == "/api/realtime":
                try:
                    from core.vespera_voice import realtime
            ...
            if path == "/api/settings":
                ...
                for key, val in data.items():
                    ...
                    if key == "startup_enabled" or key == "launch_on_startup":
                        try:
                            from core.startup_manager import set_registry_run_key
