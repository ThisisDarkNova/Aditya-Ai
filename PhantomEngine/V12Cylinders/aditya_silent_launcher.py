# modules/aditya_silent_launcher.py
"""
╔══════════════════════════════════════════════════════════════╗
║           ADITYA Silent Launcher Engine                      ║
...
USAGE:
    from V12Cylinders.aditya_silent_launcher import AdityaSilentLauncher
    launcher = AdityaSilentLauncher()
...
# ── Logger ────────────────────────────────────────────────────────────────────
logger = logging.getLogger("aditya-silent-launcher")
...
# Add/extend this as Aditya learns new apps.
...
class AdityaSilentLauncher:
    """
    The core silent launcher engine for Aditya OS.
    ...
    def run_silent(self, exe_path: str, args: list[str] = None) -> str:
        ...
        Use this for CLI tools that Aditya runs internally (e.g., ffmpeg, yt-dlp).
...
silent_launcher = AdityaSilentLauncher()


# ── Convenience wrappers (used by aditya_core.py command router) ──────────────
