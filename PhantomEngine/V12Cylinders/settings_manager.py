...
"""
Thread-safe settings manager for Aditya.
...
logger = logging.getLogger("aditya-settings")
...
class SettingsManager:
    """
    Centralized, thread-safe, and crash-resilient manager for Aditya's settings.
    """
    ...
    def load(self) -> None:
        ...
        with self._lock:
            ...
            from V12Cylinders.aditya_safety import validate_settings_dict
