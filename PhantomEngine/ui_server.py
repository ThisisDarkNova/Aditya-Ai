            ...
            try:
                if _current_status["chat_history"][-1]["role"] == "ai":
                    ...
                    if last_user and last_ai:
                        import NeuralCore.aditya_memory
    ...
    def do_GET(self):
        ...
        try:
            ...
            if path == "/api/realtime":
                try:
                    from NeuralCore.aditya_voice import realtime
            ...
            if path == "/api/resolve-app":
                try:
                    ...
                    from V12Cylinders.aditya_app_resolver import app_resolver
        ...
        try:
            if path == "/api/open-anything":
                ...
                try:
                    import re
                    from V12Cylinders.aditya_app_resolver import app_resolver
                    from V12Cylinders.aditya_silent_launcher import silent_launcher
