...
class MorningBriefing:
    ...
    def generate_briefing(self):
        ...
        if not self.client:
            return "Please configure the Gemini API key in PhantomEngine/.env to enable AI briefings."
        ...
        prompt = f"""
        You are Aditya, a highly advanced, luxurious Sentient Operating System. 
