...
export default function Profile({ memory, saveWraithglassMemoryEngine, chatHistory = [], realtimeStats = {} }) {
  ...
  const hoursWithWraithglass = `${Math.max(1, Math.round(uptimeSecs / 3600))}h`;
  ...
  const stats = [
    ...
    { label: 'Hours with Wraithglass', value: hoursWithWraithglass, icon: Clock, color: '#22C55E' },
